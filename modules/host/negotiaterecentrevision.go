...
func (h *Host) managedRPCRecentRevision(conn net.Conn) (types.FileContractID, *storageObligation, error) {
	...
	if err != nil {
		return types.FileContractID{}, nil, extendErr("could not read file contract id: ", ErrorConnection(err.Error()))
	}
	...
	if err != nil {
		return types.FileContractID{}, nil, extendErr("cound not write challenge: ", ErrorConnection(err.Error()))
	}
	...
	if err != nil {
		return types.FileContractID{}, nil, extendErr("could not read challenge response: ", ErrorConnection(err.Error()))
	}
	...
	if err != nil {
		...
		return types.FileContractID{}, nil, extendErr("challenge failed: ", err)
	}
