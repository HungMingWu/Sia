...
copying. The library
[entropy-mnemonics](https://github.com/HungMingWu/entropy-mnemonics) is used
when encoding.
...
```javascript
{
  "transaction": {
    ...
    // desired.
    "transaction": {
      // See types.Transaction in https://github.com/HungMingWu/Sia/blob/master/types/transactions.go
    },
