...
github.com/HungMingWu/Sia/...`. This will download Sia and its dependencies
and install binaries in `$GOPATH/bin`.

After downloading, you can find the Sia source code in
`$GOPATH/src/github.com/HungMingWu/Sia`. To build the release binary, run
...
```
consensus/fork.go:4:2: cannot find package "github.com/HungMingWu/Sia/crypto" in any of:
    /usr/lib/go/src/github.com/HungMingWu/Sia/crypto (from $GOROOT)
    /home/user/gopath/src/github.com/HungMingWu/Sia/crypto (from $GOPATH)
```
